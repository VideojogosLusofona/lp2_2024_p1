<!--
Projeto 1 de Linguagens de Programação II 2024/25 (c) by Nuno Fachada

Projeto 1 de Linguagens de Programação II 2024/25 is licensed under a
...
# Projeto 1 de Linguagens de Programação II 2024/25

## Introdução

Os grupos devem implementar, em Unity 6000.x LTS, os estágios iniciais de um
...
Os projetos serão automaticamente clonados às **23h00 de 17 de novembro** sendo
...
a sessão de avaliação de _live coding_ agendada para dia 25 de novembro. Por
...
Atenção que é necessário terem instalado o [.NET SDK 8.0] para executarem estes
projetos.
...
passado) ou [MVP] (_Model View Presenter_, discutida [aqui][livro_unity]), e ser
desenvolvido tendo em conta os princípios de programação orientada a objetos,
como é o caso, entre outros, dos princípios [SOLID]. Estes princípios devem ser
balanceados com o princípio [KISS], crucial no desenvolvimento de qualquer
aplicação.
...
$N = 3.5 \times O1 \times O2 \times O3 \times O4 \times O5 \times D$
...
o repositório do projeto será automaticamente clonado às **23h00 de de 17 de
novembro de 2024**. Certifiquem-se de que a aplicação está funcional e que todos
...
[livro_unity]:https://moodle.ensinolusofona.pt/mod/resource/view.php?id=374341